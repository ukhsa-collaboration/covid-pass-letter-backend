namespace CovidLetter.Backend.Common.Application.Encoders;

internal class Base45Encoding
{
    ...
    public static byte[] GetBytes(string value)
    {
        ...
        result[^1] = (byte)(buffer[buffer.Length - 2] + (BaseSize * buffer[^1])); // result is always in the range 0-255 - % ByteSize omitted.
        return result;
    }
}
